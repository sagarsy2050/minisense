...
- [`docs/example_questions.md`](docs/example_questions.md) — 10 real business questions run end-to-end (routing, DataAgent/ComparisonAgent/RAGAgent output, final answer) — reproduce any with `python -m minisense.cli "<question>"`.
